    ...
    <div className="min-h-screen bg-[#0A0A0B] text-white flex items-center justify-center px-4">
          ...
          <div>
            ...
            <div className="flex justify-end -mt-2">
              <button
                ...
                className="text-xs text-white/30 hover:text-[#C6A664] transition-colors"
              >
                Forgot password?
              </button>
            </div>
      ...
      {resetMode && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm px-4">
          <div className="bg-[#0A0A0B] border border-white/[0.08] rounded-xl p-6 w-full max-w-sm">
            ...
            {resetSent ? (
              <div className="text-center py-6">
                <div className="w-10 h-10 rounded-full bg-[#C6A664]/10 border border-[#C6A664]/20 flex items-center justify-center mx-auto mb-3">
                  <svg className="w-5 h-5 text-[#C6A664]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                {typeof window !== 'undefined' && window.location.hostname === 'localhost' && (
                  <p className="mt-3 text-[10px] text-white/20">
                    ...
                    <a href="http://localhost:54324" target="_blank" className="text-[#C6A664]/50 hover:text-[#C6A664] underline">
                ...
                <button
                  ...
                  className="mt-4 text-xs text-[#C6A664] hover:text-white transition-colors"
                >
                  Back to sign in
                </button>
              </div>
              ...
              <>
                <input
                  ...
                  onChange={(e) => setEmail(e.target.value)}
                  placeholder="you@example.com"
                  className="w-full bg-white/[0.04] border border-white/10 rounded-sm px-4 py-3 text-sm text-white placeholder-white/20 focus:outline-none focus:border-[#C6A664]/40 transition-all mb-4"
                />
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="flex-1 py-2.5 bg-[#C6A664] text-black text-xs font-bold rounded-sm hover:bg-white transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                  >
