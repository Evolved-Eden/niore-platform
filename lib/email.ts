            ...
            <tr>
              <td align="center">
                <table width="480" cellpadding="0" cellspacing="0" style="background:#0d0d18;border:1px solid rgba(255,255,255,0.06);border-radius:4px;padding:40px;">
                  ...
                  <tr>
                    <td align="center" style="padding-bottom:24px;">
                      <a href="${process.env.NEXT_PUBLIC_APP_URL || 'https://app.evolvededen.com'}/dashboard" style="display:inline-block;padding:14px 32px;background:#c8ff00;color:#000000;font-size:14px;font-weight:700;text-decoration:none;border-radius:4px;">
                        Go to Dashboard
                      </a>
                    </td>
                  </tr>
