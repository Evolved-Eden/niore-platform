...
('business_os', 'Business OS', 'SMBs and growing companies -- full CRM, sales, marketing, ops, finance, HR automation.', 'Small-to-mid businesses that need the full commercial stack.', array['os_business','client_teams']),
